...
insert into user (password,role_name,user_name) values('123456', 'businessAnalysist', 'ipek@gmail.com');
...
insert into metric(actual_end_date, metric_type, original_end_date, start_date, task_entity_id, user_entity_id) values( '2020-05-07', 'BUGFIX',  '2020-05-10', '2020-03-01', 1, 1);